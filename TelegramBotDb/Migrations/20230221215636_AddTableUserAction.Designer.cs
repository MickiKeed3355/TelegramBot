...
namespace TelegramBotDb.Migrations
{
    ...
    [Migration("20230221215636_AddTableUserAction")]
    partial class AddTableUserAction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TelegramBot.Data.Model.DishUserAccess", b =>
                {
                    b.HasOne("TelegramBotDb.Model.Dish", "Dish")
                        .WithOne("DishUserAccess")
                        .HasForeignKey("TelegramBot.Data.Model.DishUserAccess", "DishId")
